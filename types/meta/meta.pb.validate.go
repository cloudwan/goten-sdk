...
func (obj *Meta) GotenValidate() error {
	...
	if subobj, ok := interface{}(obj.Services).(gotenvalidate.Validator); ok {
		if err := subobj.GotenValidate(); err != nil {
			return gotenvalidate.NewValidationError("Meta", "services", obj.Services, "nested object validation failed", err)
		}
	}

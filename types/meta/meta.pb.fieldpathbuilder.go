...
func (MetaFieldPathBuilder) Services() MetaPathSelectorServices {
	return MetaPathSelectorServices{}
}
...
func (s MetaPathSelectorCreateTime) WithValue(value *timestamppb.Timestamp) *Meta_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*Meta_FieldTerminalPathValue)
}

func (s MetaPathSelectorCreateTime) WithArrayOfValues(values []*timestamppb.Timestamp) *Meta_FieldTerminalPathArrayOfValues {
...
func (s MetaPathSelectorUpdateTime) WithValue(value *timestamppb.Timestamp) *Meta_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*Meta_FieldTerminalPathValue)
}

func (s MetaPathSelectorUpdateTime) WithArrayOfValues(values []*timestamppb.Timestamp) *Meta_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*Meta_FieldTerminalPathArrayOfValues)
}
...
func (s MetaPathSelectorDeleteTime) WithValue(value *timestamppb.Timestamp) *Meta_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*Meta_FieldTerminalPathValue)
}

func (s MetaPathSelectorDeleteTime) WithArrayOfValues(values []*timestamppb.Timestamp) *Meta_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*Meta_FieldTerminalPathArrayOfValues)
}
...
func (MetaPathSelectorServices) FieldPath() *Meta_FieldTerminalPath {
	return &Meta_FieldTerminalPath{selector: Meta_FieldPathSelectorServices}
}

func (s MetaPathSelectorServices) WithValue(value *ServicesInfo) *Meta_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*Meta_FieldTerminalPathValue)
}

func (s MetaPathSelectorServices) WithArrayOfValues(values []*ServicesInfo) *Meta_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*Meta_FieldTerminalPathArrayOfValues)
}

func (MetaPathSelectorServices) WithSubPath(subPath ServicesInfo_FieldPath) *Meta_FieldSubPath {
	return &Meta_FieldSubPath{selector: Meta_FieldPathSelectorServices, subPath: subPath}
}

func (s MetaPathSelectorServices) WithSubValue(subPathValue ServicesInfo_FieldPathValue) *Meta_FieldSubPathValue {
	return &Meta_FieldSubPathValue{Meta_FieldPath: s.WithSubPath(subPathValue), subPathValue: subPathValue}
}

func (s MetaPathSelectorServices) WithSubArrayOfValues(subPathArrayOfValues ServicesInfo_FieldPathArrayOfValues) *Meta_FieldSubPathArrayOfValues {
	return &Meta_FieldSubPathArrayOfValues{Meta_FieldPath: s.WithSubPath(subPathArrayOfValues), subPathArrayOfValues: subPathArrayOfValues}
}

func (s MetaPathSelectorServices) WithSubArrayItemValue(subPathArrayItemValue ServicesInfo_FieldPathArrayItemValue) *Meta_FieldSubPathArrayItemValue {
	return &Meta_FieldSubPathArrayItemValue{Meta_FieldPath: s.WithSubPath(subPathArrayItemValue), subPathItemValue: subPathArrayItemValue}
}

func (MetaPathSelectorServices) OwningService() MetaPathSelectorServicesOwningService {
	return MetaPathSelectorServicesOwningService{}
}

func (MetaPathSelectorServices) AllowedServices() MetaPathSelectorServicesAllowedServices {
	return MetaPathSelectorServicesAllowedServices{}
}

type MetaPathSelectorServicesOwningService struct{}

func (MetaPathSelectorServicesOwningService) FieldPath() *Meta_FieldSubPath {
	return &Meta_FieldSubPath{
		selector: Meta_FieldPathSelectorServices,
		subPath:  NewServicesInfoFieldPathBuilder().OwningService().FieldPath(),
	}
}

func (s MetaPathSelectorServicesOwningService) WithValue(value string) *Meta_FieldSubPathValue {
	return s.FieldPath().WithIValue(value).(*Meta_FieldSubPathValue)
}

func (s MetaPathSelectorServicesOwningService) WithArrayOfValues(values []string) *Meta_FieldSubPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*Meta_FieldSubPathArrayOfValues)
}

type MetaPathSelectorServicesAllowedServices struct{}

func (MetaPathSelectorServicesAllowedServices) FieldPath() *Meta_FieldSubPath {
	return &Meta_FieldSubPath{
		selector: Meta_FieldPathSelectorServices,
		subPath:  NewServicesInfoFieldPathBuilder().AllowedServices().FieldPath(),
	}
}

func (s MetaPathSelectorServicesAllowedServices) WithValue(value []string) *Meta_FieldSubPathValue {
	return s.FieldPath().WithIValue(value).(*Meta_FieldSubPathValue)
}

func (s MetaPathSelectorServicesAllowedServices) WithArrayOfValues(values [][]string) *Meta_FieldSubPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*Meta_FieldSubPathArrayOfValues)
}

func (s MetaPathSelectorServicesAllowedServices) WithItemValue(value string) *Meta_FieldSubPathArrayItemValue {
	return s.FieldPath().WithIArrayItemValue(value).(*Meta_FieldSubPathArrayItemValue)
}
...
func NewServicesInfoFieldPathBuilder() ServicesInfoFieldPathBuilder {
	return ServicesInfoFieldPathBuilder{}
}
func (ServicesInfoFieldPathBuilder) OwningService() ServicesInfoPathSelectorOwningService {
	return ServicesInfoPathSelectorOwningService{}
}
func (ServicesInfoFieldPathBuilder) AllowedServices() ServicesInfoPathSelectorAllowedServices {
	return ServicesInfoPathSelectorAllowedServices{}
}

type ServicesInfoPathSelectorOwningService struct{}

func (ServicesInfoPathSelectorOwningService) FieldPath() *ServicesInfo_FieldTerminalPath {
	return &ServicesInfo_FieldTerminalPath{selector: ServicesInfo_FieldPathSelectorOwningService}
}

func (s ServicesInfoPathSelectorOwningService) WithValue(value string) *ServicesInfo_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*ServicesInfo_FieldTerminalPathValue)
}

func (s ServicesInfoPathSelectorOwningService) WithArrayOfValues(values []string) *ServicesInfo_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*ServicesInfo_FieldTerminalPathArrayOfValues)
}

type ServicesInfoPathSelectorAllowedServices struct{}

func (ServicesInfoPathSelectorAllowedServices) FieldPath() *ServicesInfo_FieldTerminalPath {
	return &ServicesInfo_FieldTerminalPath{selector: ServicesInfo_FieldPathSelectorAllowedServices}
}

func (s ServicesInfoPathSelectorAllowedServices) WithValue(value []string) *ServicesInfo_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*ServicesInfo_FieldTerminalPathValue)
}

func (s ServicesInfoPathSelectorAllowedServices) WithArrayOfValues(values [][]string) *ServicesInfo_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*ServicesInfo_FieldTerminalPathArrayOfValues)
}

func (s ServicesInfoPathSelectorAllowedServices) WithItemValue(value string) *ServicesInfo_FieldTerminalPathArrayItemValue {
	return s.FieldPath().WithIArrayItemValue(value).(*ServicesInfo_FieldTerminalPathArrayItemValue)
}

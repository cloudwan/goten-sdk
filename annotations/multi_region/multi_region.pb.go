...
var file_goten_annotations_multi_region_proto_goTypes = []interface{}{
...
func file_goten_annotations_multi_region_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_goten_annotations_multi_region_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Region); i {
			case 0:
				return &v.state
			case 1:
		...
		file_goten_annotations_multi_region_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_goten_annotations_multi_region_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {

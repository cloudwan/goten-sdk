...
// ScopeAttributeOverride carries per-resource overrides for a scope attribute's spec.
// Absent fields mean "inherit the attribute definition's default".
type ScopeAttributeOverride struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Overrides ScopeAttributeSpec.optional for this attribute on the referencing resource.
	// Absent means "inherit the attribute definition's default".
	Optional *wrapperspb.BoolValue `protobuf:"bytes,1,opt,name=optional,proto3" json:"optional,omitempty"`
}

func (x *ScopeAttributeOverride) Reset() {
	*x = ScopeAttributeOverride{}
	if protoimpl.UnsafeEnabled {
...
func (x *ScopeAttributeOverride) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ScopeAttributeOverride) ProtoMessage() {}

func (x *ScopeAttributeOverride) ProtoReflect() protoreflect.Message {
	mi := &file_goten_annotations_resource_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ScopeAttributeOverride.ProtoReflect.Descriptor instead.
func (*ScopeAttributeOverride) Descriptor() ([]byte, []int) {
	return file_goten_annotations_resource_proto_rawDescGZIP(), []int{3}
}

func (x *ScopeAttributeOverride) GetOptional() *wrapperspb.BoolValue {
	if x != nil {
		return x.Optional
	}
	return nil
...
type ResourceSpec struct {
	...
	// Per-resource overrides for scope attribute behavior. Each key must be an exact
	// match of an entry in scope_attributes. Each override shadows the corresponding
	// field in the attribute's ScopeAttributeSpec for this resource only.
	// Duplicate entries in scope_attributes are not permitted.
	ScopeAttributeOverrides map[string]*ScopeAttributeOverride `protobuf:"bytes,13,rep,name=scope_attribute_overrides,json=scopeAttributeOverrides,proto3" json:"scope_attribute_overrides,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	// SystemCatalog, when set, marks the resource kind as a shared system
	// catalog (see SystemCatalogSpec). Only meaningful for kinds whose name
	// patterns allow a parentless form (i.e. the api-skeleton resource entry
	// has an empty string in its `parents` list).
	SystemCatalog *SystemCatalogSpec `protobuf:"bytes,14,opt,name=system_catalog,json=systemCatalog,proto3" json:"system_catalog,omitempty"`
...
func (x *ResourceSpec) GetScopeAttributeOverrides() map[string]*ScopeAttributeOverride {
	if x != nil {
		return x.ScopeAttributeOverrides
	}
	return nil
}
...
func (x *ResourceSpec) GetSystemCatalog() *SystemCatalogSpec {
	if x != nil {
		return x.SystemCatalog
	}
	return nil
}
...
// SystemCatalogSpec marks a resource kind as a "shared system catalog":
// instances of the kind created under the system scope (i.e. with no
// project/org parent) are intended to be visible to every project/org and
// referenceable from project/org-scoped resources, even though the caller
// holds no system-scope RoleBinding. The IAM layer consults the resource
// descriptor at runtime (via gotenresource.GetSystemCatalog) and, for
// permission checks listed in inherit_permission_ids below that would
// otherwise be evaluated at the system scope, evaluates them at the
// caller's acting project/org scope instead.
//
// Mutating permissions (.create, .update, .delete, .setIamPolicy,
// .testIamPermissions) MUST NOT be listed here. Writes to system-scoped
// instances always require a real system-scope RoleBinding. Code generation
// does not enforce this at compile time but the runtime registration
// verifies that the kind supports a parentless name pattern (otherwise the
...
type SystemCatalogSpec struct {
	...
	// inherit_permission_ids is a whitelist of raw IAM permission IDs
	// (without the service domain prefix) that a project/org-scope
	// RoleBinding may satisfy on behalf of system scope. Examples:
	// "chatModels.get", "chatModels.list", "chatModels!attach",
	// "connectors.list", "connectors!attach".
	InheritPermissionIds []string `protobuf:"bytes,1,rep,name=inherit_permission_ids,json=inheritPermissionIds,proto3" json:"inherit_permission_ids,omitempty"`
}

func (x *SystemCatalogSpec) Reset() {
	*x = SystemCatalogSpec{}
	if protoimpl.UnsafeEnabled {
...
func (x *SystemCatalogSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SystemCatalogSpec) ProtoMessage() {}

func (x *SystemCatalogSpec) ProtoReflect() protoreflect.Message {
	mi := &file_goten_annotations_resource_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SystemCatalogSpec.ProtoReflect.Descriptor instead.
func (*SystemCatalogSpec) Descriptor() ([]byte, []int) {
	return file_goten_annotations_resource_proto_rawDescGZIP(), []int{5}
}

func (x *SystemCatalogSpec) GetInheritPermissionIds() []string {
	if x != nil {
		return x.InheritPermissionIds
	}
	return nil
}
...
func (*SearchSpec) Descriptor() ([]byte, []int) {
	return file_goten_annotations_resource_proto_rawDescGZIP(), []int{6}
}
...
func (x *ResourceChange) Reset() {
	*x = ResourceChange{}
	if protoimpl.UnsafeEnabled {
		mi := &file_goten_annotations_resource_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ResourceChange) Descriptor() ([]byte, []int) {
	return file_goten_annotations_resource_proto_rawDescGZIP(), []int{7}
}
...
func (x *ViewSpec_Field) Reset() {
	*x = ViewSpec_Field{}
	if protoimpl.UnsafeEnabled {
		mi := &file_goten_annotations_resource_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_goten_annotations_resource_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1d, 0x67, 0x6f, 0x74, 0x65, 0x6e, 0x2f, 0x61,
	...
	0x6f, 0x6e, 0x61, 0x6c, 0x22, 0x50, 0x0a, 0x16, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x41, 0x74, 0x74,
	0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x4f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x12, 0x36,
	0x0a, 0x08, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
	0x75, 0x66, 0x2e, 0x42, 0x6f, 0x6f, 0x6c, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x08, 0x6f, 0x70,
	0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x22, 0xff, 0x06, 0x0a, 0x0c, 0x52, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x53, 0x70, 0x65, 0x63, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x6c, 0x75, 0x72, 0x61,
	...
	,
	...
	,
	...
	0x6f, 0x6e, 0x73, 0x18, 0x93, 0x9b, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x67, 0x6f,
	0x74, 0x65, 0x6e, 0x2e, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x0e,
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x3a, 0x71,
	0x0a, 0x0f, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x5f, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74,
	...
	,
...
var file_goten_annotations_resource_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_goten_annotations_resource_proto_goTypes = []any{
	...
	(*ScopeAttributeOverride)(nil),       // 3: goten.annotations.ScopeAttributeOverride
	(*ResourceSpec)(nil),                 // 4: goten.annotations.ResourceSpec
	(*SystemCatalogSpec)(nil),            // 5: goten.annotations.SystemCatalogSpec
	(*SearchSpec)(nil),                   // 6: goten.annotations.SearchSpec
	(*ResourceChange)(nil),               // 7: goten.annotations.ResourceChange
	(*ViewSpec_Field)(nil),               // 8: goten.annotations.ViewSpec.Field
	nil,                                  // 9: goten.annotations.ResourceSpec.ScopeAttributeOverridesEntry
	(view.View)(0),                       // 10: goten.types.View
	(*wrapperspb.BoolValue)(nil),         // 11: google.protobuf.BoolValue
	(goten.OnReferencedObjectDeleted)(0), // 12: goten.annotations.OnReferencedObjectDeleted
	(*descriptorpb.MessageOptions)(nil),  // 13: google.protobuf.MessageOptions
}
var file_goten_annotations_resource_proto_depIdxs = []int32{
	10, // 0: goten.annotations.ViewSpec.view:type_name -> goten.types.View
	8,  // 1: goten.annotations.ViewSpec.fields:type_name -> goten.annotations.ViewSpec.Field
	11, // 2: goten.annotations.ScopeAttributeOverride.optional:type_name -> google.protobuf.BoolValue
	9,  // 3: goten.annotations.ResourceSpec.scope_attribute_overrides:type_name -> goten.annotations.ResourceSpec.ScopeAttributeOverridesEntry
	12, // 4: goten.annotations.ResourceSpec.on_parent_deleted_behavior:type_name -> goten.annotations.OnReferencedObjectDeleted
	0,  // 5: goten.annotations.ResourceSpec.views:type_name -> goten.annotations.ViewSpec
	5,  // 6: goten.annotations.ResourceSpec.system_catalog:type_name -> goten.annotations.SystemCatalogSpec
	1,  // 7: goten.annotations.ResourceSpec.pager:type_name -> goten.annotations.PagerSpec
	3,  // 8: goten.annotations.ResourceSpec.ScopeAttributeOverridesEntry.value:type_name -> goten.annotations.ScopeAttributeOverride
	13, // 9: goten.annotations.resource:extendee -> google.protobuf.MessageOptions
	13, // 10: goten.annotations.resource_change:extendee -> google.protobuf.MessageOptions
	13, // 11: goten.annotations.scope_attribute:extendee -> google.protobuf.MessageOptions
	13, // 12: goten.annotations.search:extendee -> google.protobuf.MessageOptions
	4,  // 13: goten.annotations.resource:type_name -> goten.annotations.ResourceSpec
	7,  // 14: goten.annotations.resource_change:type_name -> goten.annotations.ResourceChange
	2,  // 15: goten.annotations.scope_attribute:type_name -> goten.annotations.ScopeAttributeSpec
	6,  // 16: goten.annotations.search:type_name -> goten.annotations.SearchSpec
...
func file_goten_annotations_resource_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_goten_annotations_resource_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_goten_annotations_resource_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_goten_annotations_resource_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_goten_annotations_resource_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*ScopeAttributeOverride); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_goten_annotations_resource_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_goten_annotations_resource_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*SystemCatalogSpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_goten_annotations_resource_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_goten_annotations_resource_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_goten_annotations_resource_proto_msgTypes[8].Exporter = func(v any, i int) any {

...
func (c *client) GetResource(ctx context.Context, in *GetResourceRequest, opts ...grpc.CallOption) (*resource.Resource, error) {
	...
	err := c.cc.Invoke(ctx, "/goten.meta.v1.ResourceService/GetResource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetResources(ctx context.Context, in *BatchGetResourcesRequest, opts ...grpc.CallOption) (*BatchGetResourcesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/goten.meta.v1.ResourceService/BatchGetResources", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListResources(ctx context.Context, in *ListResourcesRequest, opts ...grpc.CallOption) (*ListResourcesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/goten.meta.v1.ResourceService/ListResources", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchResource(ctx context.Context, in *WatchResourceRequest, opts ...grpc.CallOption) (WatchResourceClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/goten.meta.v1.ResourceService/WatchResource", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchResources(ctx context.Context, in *WatchResourcesRequest, opts ...grpc.CallOption) (WatchResourcesClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/goten.meta.v1.ResourceService/WatchResources", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreateResource(ctx context.Context, in *CreateResourceRequest, opts ...grpc.CallOption) (*resource.Resource, error) {
	out := new(resource.Resource)
	err := c.cc.Invoke(ctx, "/goten.meta.v1.ResourceService/CreateResource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdateResource(ctx context.Context, in *UpdateResourceRequest, opts ...grpc.CallOption) (*resource.Resource, error) {
	out := new(resource.Resource)
	err := c.cc.Invoke(ctx, "/goten.meta.v1.ResourceService/UpdateResource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) DeleteResource(ctx context.Context, in *DeleteResourceRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/goten.meta.v1.ResourceService/DeleteResource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil

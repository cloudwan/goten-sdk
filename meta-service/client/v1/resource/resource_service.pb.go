...
type CreateResourceRequest struct {
	...
	Resource *resource.Resource `protobuf:"bytes,2,opt,name=resource,proto3" json:"resource,omitempty"`
	// Optional masking applied to response object to reduce message response
	// size.
	ResponseMask *CreateResourceRequest_ResponseMask `protobuf:"bytes,3,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty"`
}
...
func (m *CreateResourceRequest) GetResponseMask() *CreateResourceRequest_ResponseMask {
	if m != nil {
...
func (m *CreateResourceRequest) SetResponseMask(fv *CreateResourceRequest_ResponseMask) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "ResponseMask", "CreateResourceRequest"))
	}
	m.ResponseMask = fv
}
...
type UpdateResourceRequest struct {
	...
	// the mask
	UpdateMask *resource.Resource_FieldMask `protobuf:"bytes,3,opt,customtype=Resource_FieldMask,name=update_mask,json=updateMask,proto3" json:"update_mask,omitempty"`
	// Conditional update applied to request if update should be executed only for
	// specific resource state. If this field is populated, then server will fetch
	// existing resource, compare with the one stored in the cas field (after
	// applying field mask) and proceed with update only and only if they match.
	// Otherwise RPC error Aborted will be returned.
	Cas *UpdateResourceRequest_CAS `protobuf:"bytes,4,opt,name=cas,proto3" json:"cas,omitempty"`
	...
	ResponseMask *UpdateResourceRequest_ResponseMask `protobuf:"bytes,6,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty"`
}
...
func (m *UpdateResourceRequest) GetResponseMask() *UpdateResourceRequest_ResponseMask {
	if m != nil {
		return m.ResponseMask
	}
	return nil
...
func (m *UpdateResourceRequest) SetResponseMask(fv *UpdateResourceRequest_ResponseMask) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "ResponseMask", "UpdateResourceRequest"))
	}
	m.ResponseMask = fv
}
...
func (m *DeleteResourceRequest) GetAllowMissing() bool {
	if m != nil {
		return m.AllowMissing
	}
	return false
...
func (m *DeleteResourceRequest) SetAllowMissing(fv bool) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "AllowMissing", "DeleteResourceRequest"))
	}
	m.AllowMissing = fv
}
...
type CreateResourceRequest_ResponseMask struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	// Types that are valid to be assigned to Masking:
	//	*CreateResourceRequest_ResponseMask_SkipEntireResponseBody
	//	*CreateResourceRequest_ResponseMask_BodyMask
	Masking isCreateResourceRequest_ResponseMask_Masking `protobuf_oneof:"masking"`
}

func (m *CreateResourceRequest_ResponseMask) Reset() {
	*m = CreateResourceRequest_ResponseMask{}
	if protoimpl.UnsafeEnabled {
...
func (m *CreateResourceRequest_ResponseMask) String() string {
	return protoimpl.X.MessageStringOf(m)
}

func (*CreateResourceRequest_ResponseMask) ProtoMessage() {}

func (m *CreateResourceRequest_ResponseMask) ProtoReflect() preflect.Message {
	mi := &goten_meta_service_proto_v1_resource_service_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && m != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		if ms.LoadMessageInfo() == nil {
...
func (*CreateResourceRequest_ResponseMask) GotenMessage() {}

// Deprecated, Use CreateResourceRequest_ResponseMask.ProtoReflect.Descriptor instead.
func (*CreateResourceRequest_ResponseMask) Descriptor() ([]byte, []int) {
	return goten_meta_service_proto_v1_resource_service_proto_rawDescGZIP(), []int{9, 0}
}

func (m *CreateResourceRequest_ResponseMask) Unmarshal(b []byte) error {
	return proto.Unmarshal(b, m)
}

func (m *CreateResourceRequest_ResponseMask) Marshal() ([]byte, error) {
	return proto.Marshal(m)
}

func (m *CreateResourceRequest_ResponseMask) MarshalJSON() ([]byte, error) {
	return protojson.MarshalOptions{}.Marshal(m)
}

func (m *CreateResourceRequest_ResponseMask) UnmarshalJSON(data []byte) error {
	return protojson.Unmarshal(data, m)
}

type isCreateResourceRequest_ResponseMask_Masking interface {
	isCreateResourceRequest_ResponseMask_Masking()
}

type CreateResourceRequest_ResponseMask_SkipEntireResponseBody struct {
...
type CreateResourceRequest_ResponseMask_BodyMask struct {
	// If this field is populated, then resource in response will contain only
	// specific fields.
	BodyMask *resource.Resource_FieldMask `protobuf:"bytes,2,opt,customtype=Resource_FieldMask,name=body_mask,json=bodyMask,proto3,oneof"`
}

func (*CreateResourceRequest_ResponseMask_SkipEntireResponseBody) isCreateResourceRequest_ResponseMask_Masking() {
}
func (*CreateResourceRequest_ResponseMask_BodyMask) isCreateResourceRequest_ResponseMask_Masking() {}
func (m *CreateResourceRequest_ResponseMask) GetMasking() isCreateResourceRequest_ResponseMask_Masking {
	if m != nil {
		return m.Masking
	}
	return nil
}
func (m *CreateResourceRequest_ResponseMask) GetSkipEntireResponseBody() bool {
	if x, ok := m.GetMasking().(*CreateResourceRequest_ResponseMask_SkipEntireResponseBody); ok {
		return x.SkipEntireResponseBody
	}
	return false
}
func (m *CreateResourceRequest_ResponseMask) GetBodyMask() *resource.Resource_FieldMask {
	if x, ok := m.GetMasking().(*CreateResourceRequest_ResponseMask_BodyMask); ok {
		return x.BodyMask
	}
	return nil
}
func (m *CreateResourceRequest_ResponseMask) SetMasking(ofv isCreateResourceRequest_ResponseMask_Masking) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "isCreateResourceRequest_ResponseMask_Masking", "CreateResourceRequest_ResponseMask"))
	}
	m.Masking = ofv
}
func (m *CreateResourceRequest_ResponseMask) SetSkipEntireResponseBody(fv bool) {
	m.SetMasking(&CreateResourceRequest_ResponseMask_SkipEntireResponseBody{SkipEntireResponseBody: fv})
}
func (m *CreateResourceRequest_ResponseMask) SetBodyMask(fv *resource.Resource_FieldMask) {
	m.SetMasking(&CreateResourceRequest_ResponseMask_BodyMask{BodyMask: fv})
}
...
type UpdateResourceRequest_CAS struct {
	...
	ConditionalState *resource.Resource `protobuf:"bytes,1,opt,name=conditional_state,json=conditionalState,proto3" json:"conditional_state,omitempty"`
...
func (m *UpdateResourceRequest_CAS) Reset() {
	*m = UpdateResourceRequest_CAS{}
	if protoimpl.UnsafeEnabled {
		mi := &goten_meta_service_proto_v1_resource_service_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
// ResponseMask allows client to reduce response message size.
type UpdateResourceRequest_ResponseMask struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	// Types that are valid to be assigned to Masking:
	//	*UpdateResourceRequest_ResponseMask_SkipEntireResponseBody
	//	*UpdateResourceRequest_ResponseMask_UpdatedFieldsOnly
	//	*UpdateResourceRequest_ResponseMask_BodyMask
	Masking isUpdateResourceRequest_ResponseMask_Masking `protobuf_oneof:"masking"`
}

func (m *UpdateResourceRequest_ResponseMask) Reset() {
	*m = UpdateResourceRequest_ResponseMask{}
	if protoimpl.UnsafeEnabled {
		mi := &goten_meta_service_proto_v1_resource_service_proto_msgTypes[15]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}

func (m *UpdateResourceRequest_ResponseMask) String() string {
	return protoimpl.X.MessageStringOf(m)
}

func (*UpdateResourceRequest_ResponseMask) ProtoMessage() {}

func (m *UpdateResourceRequest_ResponseMask) ProtoReflect() preflect.Message {
	mi := &goten_meta_service_proto_v1_resource_service_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && m != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		if ms.LoadMessageInfo() == nil {
...
func (*UpdateResourceRequest_ResponseMask) GotenMessage() {}

// Deprecated, Use UpdateResourceRequest_ResponseMask.ProtoReflect.Descriptor instead.
func (*UpdateResourceRequest_ResponseMask) Descriptor() ([]byte, []int) {
	return goten_meta_service_proto_v1_resource_service_proto_rawDescGZIP(), []int{10, 1}
}

func (m *UpdateResourceRequest_ResponseMask) Unmarshal(b []byte) error {
	return proto.Unmarshal(b, m)
}

func (m *UpdateResourceRequest_ResponseMask) Marshal() ([]byte, error) {
	return proto.Marshal(m)
}

func (m *UpdateResourceRequest_ResponseMask) MarshalJSON() ([]byte, error) {
	return protojson.MarshalOptions{}.Marshal(m)
}

func (m *UpdateResourceRequest_ResponseMask) UnmarshalJSON(data []byte) error {
	return protojson.Unmarshal(data, m)
}

type isUpdateResourceRequest_ResponseMask_Masking interface {
	isUpdateResourceRequest_ResponseMask_Masking()
}

type UpdateResourceRequest_ResponseMask_SkipEntireResponseBody struct {
	// If this flag has value true, then response will contain just empty
	// resource without any fields populated. Field body_mask is ignored if
	// set.
	SkipEntireResponseBody bool `protobuf:"varint,1,opt,name=skip_entire_response_body,json=skipEntireResponseBody,proto3,oneof"`
}
type UpdateResourceRequest_ResponseMask_UpdatedFieldsOnly struct {
...
type UpdateResourceRequest_ResponseMask_BodyMask struct {
	// If this field is populated, then resource in response will contain only
	// specific fields. If skip_entire_response_body is true, this field is
	// ignored.
	BodyMask *resource.Resource_FieldMask `protobuf:"bytes,3,opt,customtype=Resource_FieldMask,name=body_mask,json=bodyMask,proto3,oneof"`
}

func (*UpdateResourceRequest_ResponseMask_SkipEntireResponseBody) isUpdateResourceRequest_ResponseMask_Masking() {
}
func (*UpdateResourceRequest_ResponseMask_UpdatedFieldsOnly) isUpdateResourceRequest_ResponseMask_Masking() {
}
func (*UpdateResourceRequest_ResponseMask_BodyMask) isUpdateResourceRequest_ResponseMask_Masking() {}
func (m *UpdateResourceRequest_ResponseMask) GetMasking() isUpdateResourceRequest_ResponseMask_Masking {
	if m != nil {
		return m.Masking
	}
	return nil
}
func (m *UpdateResourceRequest_ResponseMask) GetSkipEntireResponseBody() bool {
	if x, ok := m.GetMasking().(*UpdateResourceRequest_ResponseMask_SkipEntireResponseBody); ok {
		return x.SkipEntireResponseBody
	}
	return false
}
func (m *UpdateResourceRequest_ResponseMask) GetUpdatedFieldsOnly() bool {
	if x, ok := m.GetMasking().(*UpdateResourceRequest_ResponseMask_UpdatedFieldsOnly); ok {
		return x.UpdatedFieldsOnly
	}
	return false
}
func (m *UpdateResourceRequest_ResponseMask) GetBodyMask() *resource.Resource_FieldMask {
	if x, ok := m.GetMasking().(*UpdateResourceRequest_ResponseMask_BodyMask); ok {
		return x.BodyMask
	}
	return nil
}
func (m *UpdateResourceRequest_ResponseMask) SetMasking(ofv isUpdateResourceRequest_ResponseMask_Masking) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "isUpdateResourceRequest_ResponseMask_Masking", "UpdateResourceRequest_ResponseMask"))
	}
	m.Masking = ofv
}
func (m *UpdateResourceRequest_ResponseMask) SetSkipEntireResponseBody(fv bool) {
	m.SetMasking(&UpdateResourceRequest_ResponseMask_SkipEntireResponseBody{SkipEntireResponseBody: fv})
}
func (m *UpdateResourceRequest_ResponseMask) SetUpdatedFieldsOnly(fv bool) {
	m.SetMasking(&UpdateResourceRequest_ResponseMask_UpdatedFieldsOnly{UpdatedFieldsOnly: fv})
}
func (m *UpdateResourceRequest_ResponseMask) SetBodyMask(fv *resource.Resource_FieldMask) {
	m.SetMasking(&UpdateResourceRequest_ResponseMask_BodyMask{BodyMask: fv})
}
...
var goten_meta_service_proto_v1_resource_service_proto_rawDesc = []byte{
	...
	0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x82, 0x03, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52,
	...
	0x01, 0x52, 0x08, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x56, 0x0a, 0x0d, 0x72,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x5f, 0x6d, 0x61, 0x73, 0x6b, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x31, 0x2e, 0x67, 0x6f, 0x74, 0x65, 0x6e, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x2e,
	...
	0x63, 0x65, 0x48, 0x00, 0x52, 0x08, 0x62, 0x6f, 0x64, 0x79, 0x4d, 0x61, 0x73, 0x6b, 0x42, 0x09,
	0x0a, 0x07, 0x6d, 0x61, 0x73, 0x6b, 0x69, 0x6e, 0x67, 0x22, 0xdf, 0x05, 0x0a, 0x15, 0x55, 0x70,
	...
	,
	...
	0x52, 0x0c, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4d, 0x61, 0x73, 0x6b, 0x1a, 0xa2,
	...
	0x0b, 0x32, 0x17, 0x2e, 0x67, 0x6f, 0x74, 0x65, 0x6e, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x76,
	0x31, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x08, 0xca, 0xc6, 0x27, 0x04,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x4d, 0x61,
	0x73, 0x6b, 0x42, 0x10, 0xb2, 0xda, 0x21, 0x0c, 0x32, 0x0a, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x48, 0x00, 0x52, 0x08, 0x62, 0x6f, 0x64, 0x79, 0x4d, 0x61, 0x73, 0x6b,
	...
	0x28, 0x09, 0x42, 0x10, 0xb2, 0xda, 0x21, 0x0c, 0x0a, 0x0a, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x61, 0x6c,
	...
	,
	...
	,
	...
	0x74, 0x1a, 0x24, 0x2e, 0x67, 0x6f, 0x74, 0x65, 0x6e, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x76,
	0x31, 0x2e, 0x57, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x65, 0x82, 0xdb, 0x21, 0x23, 0x0a, 0x08, 0x52,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x05, 0x77, 0x61, 0x74, 0x63, 0x68, 0x2a, 0x06,
	0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0x08, 0x12, 0x06, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65,
	0xa2, 0xdc, 0x21, 0x02, 0x08, 0x01, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x2e, 0x22, 0x2c, 0x2f, 0x6d,
	...
	,
	...
	,
	...
	0x79, 0x22, 0x58, 0x82, 0xdb, 0x21, 0x1a, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x12, 0x06, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x2a, 0x06, 0x0a, 0x04, 0x6e, 0x61, 0x6d,
	0x65, 0xa2, 0xdc, 0x21, 0x02, 0x10, 0x01, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x28, 0x2a, 0x26, 0x2f,
	...
	0x65, 0x73, 0x2f, 0x2a, 0x7d, 0x8a, 0xcc, 0x26, 0x02, 0x10, 0x01, 0x1a, 0x06, 0xca, 0x41, 0x00,
	0xd2, 0x41, 0x00, 0x42, 0x9f, 0x02, 0xe8, 0xde, 0x21, 0x00, 0x82, 0xff, 0xd0, 0x02, 0x4c, 0x0a,
	0x0f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72,
	...
	0x76, 0x31, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x8a, 0xff, 0xd0, 0x02, 0x4c,
	...
	0x2f, 0x76, 0x31, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x0a, 0x14, 0x63, 0x6f,
	0x6d, 0x2e, 0x67, 0x6f, 0x74, 0x65, 0x6e, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x70, 0x62, 0x2e,
	0x76, 0x31, 0x42, 0x14, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x65, 0x72, 0x76,
	...
	0x63, 0x65, 0x2f, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2f, 0x76, 0x31, 0x2f, 0x72, 0x65, 0x73,
...
var goten_meta_service_proto_v1_resource_service_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var goten_meta_service_proto_v1_resource_service_proto_goTypes = []interface{}{
	...
	(*CreateResourceRequest_ResponseMask)(nil),     // 13: goten.meta.v1.CreateResourceRequest.ResponseMask
	(*UpdateResourceRequest_CAS)(nil),              // 14: goten.meta.v1.UpdateResourceRequest.CAS
	(*UpdateResourceRequest_ResponseMask)(nil),     // 15: goten.meta.v1.UpdateResourceRequest.ResponseMask
	(*resource.Resource_FieldMask)(nil),            // 16: goten.meta.v1.Resource_FieldMask
	(view.View)(0),                                 // 17: goten.types.View
	(*resource.Resource)(nil),                      // 18: goten.meta.v1.Resource
	(*resource.ResourceChange)(nil),                // 19: goten.meta.v1.ResourceChange
...
var goten_meta_service_proto_v1_resource_service_proto_depIdxs = []int32{
	16, // 0: goten.meta.v1.GetResourceRequest.field_mask:type_name -> goten.meta.v1.Resource_FieldMask
	17, // 1: goten.meta.v1.GetResourceRequest.view:type_name -> goten.types.View
	16, // 2: goten.meta.v1.BatchGetResourcesRequest.field_mask:type_name -> goten.meta.v1.Resource_FieldMask
	17, // 3: goten.meta.v1.BatchGetResourcesRequest.view:type_name -> goten.types.View
	18, // 4: goten.meta.v1.BatchGetResourcesResponse.resources:type_name -> goten.meta.v1.Resource
	16, // 5: goten.meta.v1.ListResourcesRequest.field_mask:type_name -> goten.meta.v1.Resource_FieldMask
	17, // 6: goten.meta.v1.ListResourcesRequest.view:type_name -> goten.types.View
	18, // 7: goten.meta.v1.ListResourcesResponse.resources:type_name -> goten.meta.v1.Resource
	16, // 8: goten.meta.v1.WatchResourceRequest.field_mask:type_name -> goten.meta.v1.Resource_FieldMask
	17, // 9: goten.meta.v1.WatchResourceRequest.view:type_name -> goten.types.View
	19, // 10: goten.meta.v1.WatchResourceResponse.change:type_name -> goten.meta.v1.ResourceChange
	20, // 11: goten.meta.v1.WatchResourcesRequest.type:type_name -> goten.types.WatchType
	21, // 12: goten.meta.v1.WatchResourcesRequest.starting_time:type_name -> google.protobuf.Timestamp
	16, // 13: goten.meta.v1.WatchResourcesRequest.field_mask:type_name -> goten.meta.v1.Resource_FieldMask
	17, // 14: goten.meta.v1.WatchResourcesRequest.view:type_name -> goten.types.View
	19, // 15: goten.meta.v1.WatchResourcesResponse.resource_changes:type_name -> goten.meta.v1.ResourceChange
	...
	18, // 17: goten.meta.v1.CreateResourceRequest.resource:type_name -> goten.meta.v1.Resource
	13, // 18: goten.meta.v1.CreateResourceRequest.response_mask:type_name -> goten.meta.v1.CreateResourceRequest.ResponseMask
	18, // 19: goten.meta.v1.UpdateResourceRequest.resource:type_name -> goten.meta.v1.Resource
	16, // 20: goten.meta.v1.UpdateResourceRequest.update_mask:type_name -> goten.meta.v1.Resource_FieldMask
	14, // 21: goten.meta.v1.UpdateResourceRequest.cas:type_name -> goten.meta.v1.UpdateResourceRequest.CAS
	15, // 22: goten.meta.v1.UpdateResourceRequest.response_mask:type_name -> goten.meta.v1.UpdateResourceRequest.ResponseMask
	16, // 23: goten.meta.v1.CreateResourceRequest.ResponseMask.body_mask:type_name -> goten.meta.v1.Resource_FieldMask
	18, // 24: goten.meta.v1.UpdateResourceRequest.CAS.conditional_state:type_name -> goten.meta.v1.Resource
	16, // 25: goten.meta.v1.UpdateResourceRequest.CAS.field_mask:type_name -> goten.meta.v1.Resource_FieldMask
	16, // 26: goten.meta.v1.UpdateResourceRequest.ResponseMask.body_mask:type_name -> goten.meta.v1.Resource_FieldMask
	0,  // 27: goten.meta.v1.ResourceService.GetResource:input_type -> goten.meta.v1.GetResourceRequest
	1,  // 28: goten.meta.v1.ResourceService.BatchGetResources:input_type -> goten.meta.v1.BatchGetResourcesRequest
	3,  // 29: goten.meta.v1.ResourceService.ListResources:input_type -> goten.meta.v1.ListResourcesRequest
	5,  // 30: goten.meta.v1.ResourceService.WatchResource:input_type -> goten.meta.v1.WatchResourceRequest
	7,  // 31: goten.meta.v1.ResourceService.WatchResources:input_type -> goten.meta.v1.WatchResourcesRequest
	9,  // 32: goten.meta.v1.ResourceService.CreateResource:input_type -> goten.meta.v1.CreateResourceRequest
	10, // 33: goten.meta.v1.ResourceService.UpdateResource:input_type -> goten.meta.v1.UpdateResourceRequest
	11, // 34: goten.meta.v1.ResourceService.DeleteResource:input_type -> goten.meta.v1.DeleteResourceRequest
	18, // 35: goten.meta.v1.ResourceService.GetResource:output_type -> goten.meta.v1.Resource
	2,  // 36: goten.meta.v1.ResourceService.BatchGetResources:output_type -> goten.meta.v1.BatchGetResourcesResponse
	4,  // 37: goten.meta.v1.ResourceService.ListResources:output_type -> goten.meta.v1.ListResourcesResponse
	6,  // 38: goten.meta.v1.ResourceService.WatchResource:output_type -> goten.meta.v1.WatchResourceResponse
	8,  // 39: goten.meta.v1.ResourceService.WatchResources:output_type -> goten.meta.v1.WatchResourcesResponse
	18, // 40: goten.meta.v1.ResourceService.CreateResource:output_type -> goten.meta.v1.Resource
	18, // 41: goten.meta.v1.ResourceService.UpdateResource:output_type -> goten.meta.v1.Resource
	22, // 42: goten.meta.v1.ResourceService.DeleteResource:output_type -> google.protobuf.Empty
...
func goten_meta_service_proto_v1_resource_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		goten_meta_service_proto_v1_resource_service_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateResourceRequest_ResponseMask); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		goten_meta_service_proto_v1_resource_service_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		goten_meta_service_proto_v1_resource_service_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateResourceRequest_ResponseMask); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	goten_meta_service_proto_v1_resource_service_proto_msgTypes[13].OneofWrappers = []interface{}{
		(*CreateResourceRequest_ResponseMask_SkipEntireResponseBody)(nil),
		(*CreateResourceRequest_ResponseMask_BodyMask)(nil),
	}
	goten_meta_service_proto_v1_resource_service_proto_msgTypes[15].OneofWrappers = []interface{}{
		(*UpdateResourceRequest_ResponseMask_SkipEntireResponseBody)(nil),
		(*UpdateResourceRequest_ResponseMask_UpdatedFieldsOnly)(nil),
		(*UpdateResourceRequest_ResponseMask_BodyMask)(nil),
	}
	type x struct{}

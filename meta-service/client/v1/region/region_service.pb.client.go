...
func (c *client) GetRegion(ctx context.Context, in *GetRegionRequest, opts ...grpc.CallOption) (*region.Region, error) {
	...
	err := c.cc.Invoke(ctx, "/goten.meta.v1.RegionService/GetRegion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetRegions(ctx context.Context, in *BatchGetRegionsRequest, opts ...grpc.CallOption) (*BatchGetRegionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/goten.meta.v1.RegionService/BatchGetRegions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListRegions(ctx context.Context, in *ListRegionsRequest, opts ...grpc.CallOption) (*ListRegionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/goten.meta.v1.RegionService/ListRegions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchRegion(ctx context.Context, in *WatchRegionRequest, opts ...grpc.CallOption) (WatchRegionClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/goten.meta.v1.RegionService/WatchRegion", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchRegions(ctx context.Context, in *WatchRegionsRequest, opts ...grpc.CallOption) (WatchRegionsClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/goten.meta.v1.RegionService/WatchRegions", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreateRegion(ctx context.Context, in *CreateRegionRequest, opts ...grpc.CallOption) (*region.Region, error) {
	out := new(region.Region)
	err := c.cc.Invoke(ctx, "/goten.meta.v1.RegionService/CreateRegion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdateRegion(ctx context.Context, in *UpdateRegionRequest, opts ...grpc.CallOption) (*region.Region, error) {
	out := new(region.Region)
	err := c.cc.Invoke(ctx, "/goten.meta.v1.RegionService/UpdateRegion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) DeleteRegion(ctx context.Context, in *DeleteRegionRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/goten.meta.v1.RegionService/DeleteRegion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil

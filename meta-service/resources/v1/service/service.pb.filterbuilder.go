...
func (b *filterCndBuilder) GlobalDomain() *filterCndBuilderGlobalDomain {
	return &filterCndBuilderGlobalDomain{builder: b.builder}
}

func (b *filterCndBuilder) ImportedServices() *filterCndBuilderImportedServices {
	return &filterCndBuilderImportedServices{builder: b.builder}
}

func (b *filterCndBuilder) UsedServices() *filterCndBuilderUsedServices {
	return &filterCndBuilderUsedServices{builder: b.builder}
}

func (b *filterCndBuilder) ImportedVersions() *filterCndBuilderImportedVersions {
	return &filterCndBuilderImportedVersions{builder: b.builder}
}
...
func (b *filterCndBuilder) ServicesCtrl() *filterCndBuilderServicesCtrl {
	return &filterCndBuilderServicesCtrl{builder: b.builder}
}
...
func (b *filterCndBuilderMultiRegionPolicy) In(values []*multi_region_policy.MultiRegionPolicy) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().MultiRegionPolicy().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicy) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().MultiRegionPolicy().FieldPath(),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicy) compare(op gotenfilter.CompareOperator, value *multi_region_policy.MultiRegionPolicy) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().MultiRegionPolicy().WithValue(value),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyEnabledRegions) In(values [][]string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().MultiRegionPolicy().EnabledRegions().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyEnabledRegions) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().MultiRegionPolicy().EnabledRegions().FieldPath(),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyEnabledRegions) Contains(value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewServiceFieldPathBuilder().MultiRegionPolicy().EnabledRegions().FieldPath(),
		Value:     NewServiceFieldPathBuilder().MultiRegionPolicy().EnabledRegions().WithItemValue(value),
	})
}

func (b *filterCndBuilderMultiRegionPolicyEnabledRegions) ContainsAnyOf(values []string) *FilterBuilder {
	pathSelector := NewServiceFieldPathBuilder().MultiRegionPolicy().EnabledRegions()
	itemValues := make([]Service_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderMultiRegionPolicyEnabledRegions) compare(op gotenfilter.CompareOperator, value []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().MultiRegionPolicy().EnabledRegions().WithValue(value),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyDefaultControlRegion) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().MultiRegionPolicy().DefaultControlRegion().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyDefaultControlRegion) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().MultiRegionPolicy().DefaultControlRegion().FieldPath(),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyDefaultControlRegion) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().MultiRegionPolicy().DefaultControlRegion().WithValue(value),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyCriteriaForDisabledSync) In(values [][]*multi_region_policy.MultiRegionPolicy_CriteriaForDisabledSync) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().MultiRegionPolicy().CriteriaForDisabledSync().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyCriteriaForDisabledSync) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().MultiRegionPolicy().CriteriaForDisabledSync().FieldPath(),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyCriteriaForDisabledSync) Contains(value *multi_region_policy.MultiRegionPolicy_CriteriaForDisabledSync) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewServiceFieldPathBuilder().MultiRegionPolicy().CriteriaForDisabledSync().FieldPath(),
		Value:     NewServiceFieldPathBuilder().MultiRegionPolicy().CriteriaForDisabledSync().WithItemValue(value),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyCriteriaForDisabledSync) ContainsAnyOf(values []*multi_region_policy.MultiRegionPolicy_CriteriaForDisabledSync) *FilterBuilder {
	pathSelector := NewServiceFieldPathBuilder().MultiRegionPolicy().CriteriaForDisabledSync()
	itemValues := make([]Service_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderMultiRegionPolicyCriteriaForDisabledSync) compare(op gotenfilter.CompareOperator, value []*multi_region_policy.MultiRegionPolicy_CriteriaForDisabledSync) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().MultiRegionPolicy().CriteriaForDisabledSync().WithValue(value),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyCriteriaForDisabledSyncResourceTypeName) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().MultiRegionPolicy().CriteriaForDisabledSync().ResourceTypeName().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyCriteriaForDisabledSyncResourceTypeName) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().MultiRegionPolicy().CriteriaForDisabledSync().ResourceTypeName().FieldPath(),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyCriteriaForDisabledSyncResourceTypeName) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().MultiRegionPolicy().CriteriaForDisabledSync().ResourceTypeName().WithValue(value),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyCriteriaForDisabledSyncSourceRegion) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().MultiRegionPolicy().CriteriaForDisabledSync().SourceRegion().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyCriteriaForDisabledSyncSourceRegion) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().MultiRegionPolicy().CriteriaForDisabledSync().SourceRegion().FieldPath(),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyCriteriaForDisabledSyncSourceRegion) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().MultiRegionPolicy().CriteriaForDisabledSync().SourceRegion().WithValue(value),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyCriteriaForDisabledSyncDestRegion) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().MultiRegionPolicy().CriteriaForDisabledSync().DestRegion().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyCriteriaForDisabledSyncDestRegion) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().MultiRegionPolicy().CriteriaForDisabledSync().DestRegion().FieldPath(),
	})
}
...
func (b *filterCndBuilderMultiRegionPolicyCriteriaForDisabledSyncDestRegion) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().MultiRegionPolicy().CriteriaForDisabledSync().DestRegion().WithValue(value),
	})
}
...
type filterCndBuilderGlobalDomain struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderGlobalDomain) Eq(value string) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderGlobalDomain) Neq(value string) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderGlobalDomain) Gt(value string) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderGlobalDomain) Gte(value string) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderGlobalDomain) Lt(value string) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderGlobalDomain) Lte(value string) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderGlobalDomain) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().GlobalDomain().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderGlobalDomain) NotIn(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().GlobalDomain().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderGlobalDomain) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().GlobalDomain().FieldPath(),
	})
}

func (b *filterCndBuilderGlobalDomain) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewServiceFieldPathBuilder().GlobalDomain().FieldPath(),
	})
}

func (b *filterCndBuilderGlobalDomain) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().GlobalDomain().WithValue(value),
	})
}

type filterCndBuilderImportedServices struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderImportedServices) Eq(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderImportedServices) Neq(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderImportedServices) Gt(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderImportedServices) Gte(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderImportedServices) Lt(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderImportedServices) Lte(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderImportedServices) In(values [][]*Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().ImportedServices().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderImportedServices) NotIn(values [][]*Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().ImportedServices().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderImportedServices) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().ImportedServices().FieldPath(),
	})
}

func (b *filterCndBuilderImportedServices) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewServiceFieldPathBuilder().ImportedServices().FieldPath(),
	})
}

func (b *filterCndBuilderImportedServices) Contains(value *Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewServiceFieldPathBuilder().ImportedServices().FieldPath(),
		Value:     NewServiceFieldPathBuilder().ImportedServices().WithItemValue(value),
	})
}

func (b *filterCndBuilderImportedServices) ContainsAnyOf(values []*Reference) *FilterBuilder {
	pathSelector := NewServiceFieldPathBuilder().ImportedServices()
	itemValues := make([]Service_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderImportedServices) ContainsAll(values []*Reference) *FilterBuilder {
	pathSelector := NewServiceFieldPathBuilder().ImportedServices()
	itemValues := make([]Service_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
...
func (b *filterCndBuilderImportedServices) compare(op gotenfilter.CompareOperator, value []*Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().ImportedServices().WithValue(value),
	})
}

type filterCndBuilderUsedServices struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderUsedServices) Eq(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderUsedServices) Neq(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderUsedServices) Gt(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderUsedServices) Gte(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderUsedServices) Lt(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderUsedServices) Lte(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderUsedServices) In(values [][]*Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().UsedServices().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderUsedServices) NotIn(values [][]*Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().UsedServices().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderUsedServices) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().UsedServices().FieldPath(),
	})
}

func (b *filterCndBuilderUsedServices) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewServiceFieldPathBuilder().UsedServices().FieldPath(),
	})
}

func (b *filterCndBuilderUsedServices) Contains(value *Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewServiceFieldPathBuilder().UsedServices().FieldPath(),
		Value:     NewServiceFieldPathBuilder().UsedServices().WithItemValue(value),
	})
}

func (b *filterCndBuilderUsedServices) ContainsAnyOf(values []*Reference) *FilterBuilder {
	pathSelector := NewServiceFieldPathBuilder().UsedServices()
	itemValues := make([]Service_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderUsedServices) ContainsAll(values []*Reference) *FilterBuilder {
	pathSelector := NewServiceFieldPathBuilder().UsedServices()
	itemValues := make([]Service_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
...
func (b *filterCndBuilderUsedServices) compare(op gotenfilter.CompareOperator, value []*Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().UsedServices().WithValue(value),
	})
}

type filterCndBuilderImportedVersions struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderImportedVersions) Eq(value []*Service_ImportedVersions) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderImportedVersions) Neq(value []*Service_ImportedVersions) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderImportedVersions) Gt(value []*Service_ImportedVersions) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderImportedVersions) Gte(value []*Service_ImportedVersions) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderImportedVersions) Lt(value []*Service_ImportedVersions) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderImportedVersions) Lte(value []*Service_ImportedVersions) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderImportedVersions) In(values [][]*Service_ImportedVersions) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().ImportedVersions().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderImportedVersions) NotIn(values [][]*Service_ImportedVersions) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().ImportedVersions().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderImportedVersions) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().ImportedVersions().FieldPath(),
	})
}

func (b *filterCndBuilderImportedVersions) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewServiceFieldPathBuilder().ImportedVersions().FieldPath(),
	})
}

func (b *filterCndBuilderImportedVersions) Contains(value *Service_ImportedVersions) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewServiceFieldPathBuilder().ImportedVersions().FieldPath(),
		Value:     NewServiceFieldPathBuilder().ImportedVersions().WithItemValue(value),
	})
}

func (b *filterCndBuilderImportedVersions) ContainsAnyOf(values []*Service_ImportedVersions) *FilterBuilder {
	pathSelector := NewServiceFieldPathBuilder().ImportedVersions()
	itemValues := make([]Service_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderImportedVersions) ContainsAll(values []*Service_ImportedVersions) *FilterBuilder {
	pathSelector := NewServiceFieldPathBuilder().ImportedVersions()
	itemValues := make([]Service_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
...
func (b *filterCndBuilderImportedVersions) compare(op gotenfilter.CompareOperator, value []*Service_ImportedVersions) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().ImportedVersions().WithValue(value),
	})
}

func (b *filterCndBuilderImportedVersions) TargetService() *filterCndBuilderImportedVersionsTargetService {
	return &filterCndBuilderImportedVersionsTargetService{builder: b.builder}
}

func (b *filterCndBuilderImportedVersions) TargetServiceVersion() *filterCndBuilderImportedVersionsTargetServiceVersion {
	return &filterCndBuilderImportedVersionsTargetServiceVersion{builder: b.builder}
}

func (b *filterCndBuilderImportedVersions) CurrentServiceVersion() *filterCndBuilderImportedVersionsCurrentServiceVersion {
	return &filterCndBuilderImportedVersionsCurrentServiceVersion{builder: b.builder}
}

type filterCndBuilderImportedVersionsTargetService struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderImportedVersionsTargetService) Eq(value *Reference) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderImportedVersionsTargetService) Neq(value *Reference) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderImportedVersionsTargetService) Gt(value *Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderImportedVersionsTargetService) Gte(value *Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderImportedVersionsTargetService) Lt(value *Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderImportedVersionsTargetService) Lte(value *Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderImportedVersionsTargetService) In(values []*Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().ImportedVersions().TargetService().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderImportedVersionsTargetService) NotIn(values []*Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().ImportedVersions().TargetService().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderImportedVersionsTargetService) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().ImportedVersions().TargetService().FieldPath(),
	})
}

func (b *filterCndBuilderImportedVersionsTargetService) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewServiceFieldPathBuilder().ImportedVersions().TargetService().FieldPath(),
	})
}

func (b *filterCndBuilderImportedVersionsTargetService) compare(op gotenfilter.CompareOperator, value *Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().ImportedVersions().TargetService().WithValue(value),
	})
}

type filterCndBuilderImportedVersionsTargetServiceVersion struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderImportedVersionsTargetServiceVersion) Eq(value string) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderImportedVersionsTargetServiceVersion) Neq(value string) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderImportedVersionsTargetServiceVersion) Gt(value string) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderImportedVersionsTargetServiceVersion) Gte(value string) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderImportedVersionsTargetServiceVersion) Lt(value string) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderImportedVersionsTargetServiceVersion) Lte(value string) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderImportedVersionsTargetServiceVersion) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().ImportedVersions().TargetServiceVersion().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderImportedVersionsTargetServiceVersion) NotIn(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().ImportedVersions().TargetServiceVersion().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderImportedVersionsTargetServiceVersion) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().ImportedVersions().TargetServiceVersion().FieldPath(),
	})
}

func (b *filterCndBuilderImportedVersionsTargetServiceVersion) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewServiceFieldPathBuilder().ImportedVersions().TargetServiceVersion().FieldPath(),
	})
}

func (b *filterCndBuilderImportedVersionsTargetServiceVersion) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().ImportedVersions().TargetServiceVersion().WithValue(value),
	})
}

type filterCndBuilderImportedVersionsCurrentServiceVersion struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderImportedVersionsCurrentServiceVersion) Eq(value string) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderImportedVersionsCurrentServiceVersion) Neq(value string) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderImportedVersionsCurrentServiceVersion) Gt(value string) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderImportedVersionsCurrentServiceVersion) Gte(value string) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderImportedVersionsCurrentServiceVersion) Lt(value string) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderImportedVersionsCurrentServiceVersion) Lte(value string) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderImportedVersionsCurrentServiceVersion) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().ImportedVersions().CurrentServiceVersion().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderImportedVersionsCurrentServiceVersion) NotIn(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().ImportedVersions().CurrentServiceVersion().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderImportedVersionsCurrentServiceVersion) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().ImportedVersions().CurrentServiceVersion().FieldPath(),
	})
}

func (b *filterCndBuilderImportedVersionsCurrentServiceVersion) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewServiceFieldPathBuilder().ImportedVersions().CurrentServiceVersion().FieldPath(),
	})
}

func (b *filterCndBuilderImportedVersionsCurrentServiceVersion) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().ImportedVersions().CurrentServiceVersion().WithValue(value),
	})
}
...
func (b *filterCndBuilderEnvRegistryGeneration) In(values []int32) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().EnvRegistryGeneration().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderEnvRegistryGeneration) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().EnvRegistryGeneration().FieldPath(),
	})
}
...
func (b *filterCndBuilderEnvRegistryGeneration) compare(op gotenfilter.CompareOperator, value int32) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().EnvRegistryGeneration().WithValue(value),
	})
}
...
func (b *filterCndBuilderAutomaticVersionSwitch) In(values []bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().AutomaticVersionSwitch().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderAutomaticVersionSwitch) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().AutomaticVersionSwitch().FieldPath(),
	})
}
...
func (b *filterCndBuilderAutomaticVersionSwitch) compare(op gotenfilter.CompareOperator, value bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().AutomaticVersionSwitch().WithValue(value),
	})
}

type filterCndBuilderServicesCtrl struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderServicesCtrl) Eq(value *Service_AllowedServicesCtrlFlag) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderServicesCtrl) Neq(value *Service_AllowedServicesCtrlFlag) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderServicesCtrl) Gt(value *Service_AllowedServicesCtrlFlag) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderServicesCtrl) Gte(value *Service_AllowedServicesCtrlFlag) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderServicesCtrl) Lt(value *Service_AllowedServicesCtrlFlag) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderServicesCtrl) Lte(value *Service_AllowedServicesCtrlFlag) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderServicesCtrl) In(values []*Service_AllowedServicesCtrlFlag) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().ServicesCtrl().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderServicesCtrl) NotIn(values []*Service_AllowedServicesCtrlFlag) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().ServicesCtrl().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderServicesCtrl) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().ServicesCtrl().FieldPath(),
	})
}

func (b *filterCndBuilderServicesCtrl) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewServiceFieldPathBuilder().ServicesCtrl().FieldPath(),
	})
}

func (b *filterCndBuilderServicesCtrl) compare(op gotenfilter.CompareOperator, value *Service_AllowedServicesCtrlFlag) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().ServicesCtrl().WithValue(value),
	})
}

func (b *filterCndBuilderServicesCtrl) IsDirty() *filterCndBuilderServicesCtrlIsDirty {
	return &filterCndBuilderServicesCtrlIsDirty{builder: b.builder}
}

func (b *filterCndBuilderServicesCtrl) Generation() *filterCndBuilderServicesCtrlGeneration {
	return &filterCndBuilderServicesCtrlGeneration{builder: b.builder}
}

type filterCndBuilderServicesCtrlIsDirty struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderServicesCtrlIsDirty) Eq(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderServicesCtrlIsDirty) Neq(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderServicesCtrlIsDirty) Gt(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderServicesCtrlIsDirty) Gte(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderServicesCtrlIsDirty) Lt(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderServicesCtrlIsDirty) Lte(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderServicesCtrlIsDirty) In(values []bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().ServicesCtrl().IsDirty().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderServicesCtrlIsDirty) NotIn(values []bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().ServicesCtrl().IsDirty().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderServicesCtrlIsDirty) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().ServicesCtrl().IsDirty().FieldPath(),
	})
}

func (b *filterCndBuilderServicesCtrlIsDirty) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewServiceFieldPathBuilder().ServicesCtrl().IsDirty().FieldPath(),
	})
}

func (b *filterCndBuilderServicesCtrlIsDirty) compare(op gotenfilter.CompareOperator, value bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().ServicesCtrl().IsDirty().WithValue(value),
	})
}

type filterCndBuilderServicesCtrlGeneration struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderServicesCtrlGeneration) Eq(value int64) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderServicesCtrlGeneration) Neq(value int64) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderServicesCtrlGeneration) Gt(value int64) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderServicesCtrlGeneration) Gte(value int64) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderServicesCtrlGeneration) Lt(value int64) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderServicesCtrlGeneration) Lte(value int64) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderServicesCtrlGeneration) In(values []int64) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().ServicesCtrl().Generation().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderServicesCtrlGeneration) NotIn(values []int64) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Service_FieldPathArrayOfValues: NewServiceFieldPathBuilder().ServicesCtrl().Generation().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderServicesCtrlGeneration) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewServiceFieldPathBuilder().ServicesCtrl().Generation().FieldPath(),
	})
}

func (b *filterCndBuilderServicesCtrlGeneration) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewServiceFieldPathBuilder().ServicesCtrl().Generation().FieldPath(),
	})
}

func (b *filterCndBuilderServicesCtrlGeneration) compare(op gotenfilter.CompareOperator, value int64) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Service_FieldPathValue: NewServiceFieldPathBuilder().ServicesCtrl().Generation().WithValue(value),
	})
}

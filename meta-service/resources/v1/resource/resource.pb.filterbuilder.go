...
func (b *filterCndBuilder) VersionedInfos() *filterCndBuilderVersionedInfos {
...
func (b *filterCndBuilderVersions) In(values [][]string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Resource_FieldPathArrayOfValues: NewResourceFieldPathBuilder().Versions().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderVersions) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewResourceFieldPathBuilder().Versions().FieldPath(),
	})
}
...
func (b *filterCndBuilderVersions) Contains(value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewResourceFieldPathBuilder().Versions().FieldPath(),
		Value:     NewResourceFieldPathBuilder().Versions().WithItemValue(value),
	})
}

func (b *filterCndBuilderVersions) ContainsAnyOf(values []string) *FilterBuilder {
	pathSelector := NewResourceFieldPathBuilder().Versions()
	itemValues := make([]Resource_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderVersions) compare(op gotenfilter.CompareOperator, value []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                op,
		Resource_FieldPathValue: NewResourceFieldPathBuilder().Versions().WithValue(value),
	})
}

type filterCndBuilderVersionedInfos struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderVersionedInfos) Eq(value []*Resource_VersionedInfo) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderVersionedInfos) Neq(value []*Resource_VersionedInfo) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderVersionedInfos) Gt(value []*Resource_VersionedInfo) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderVersionedInfos) Gte(value []*Resource_VersionedInfo) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderVersionedInfos) Lt(value []*Resource_VersionedInfo) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderVersionedInfos) Lte(value []*Resource_VersionedInfo) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderVersionedInfos) In(values [][]*Resource_VersionedInfo) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Resource_FieldPathArrayOfValues: NewResourceFieldPathBuilder().VersionedInfos().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderVersionedInfos) NotIn(values [][]*Resource_VersionedInfo) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Resource_FieldPathArrayOfValues: NewResourceFieldPathBuilder().VersionedInfos().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderVersionedInfos) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewResourceFieldPathBuilder().VersionedInfos().FieldPath(),
	})
}

func (b *filterCndBuilderVersionedInfos) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewResourceFieldPathBuilder().VersionedInfos().FieldPath(),
	})
}

func (b *filterCndBuilderVersionedInfos) Contains(value *Resource_VersionedInfo) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewResourceFieldPathBuilder().VersionedInfos().FieldPath(),
		Value:     NewResourceFieldPathBuilder().VersionedInfos().WithItemValue(value),
	})
}

func (b *filterCndBuilderVersionedInfos) ContainsAnyOf(values []*Resource_VersionedInfo) *FilterBuilder {
	pathSelector := NewResourceFieldPathBuilder().VersionedInfos()
	itemValues := make([]Resource_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderVersionedInfos) ContainsAll(values []*Resource_VersionedInfo) *FilterBuilder {
	pathSelector := NewResourceFieldPathBuilder().VersionedInfos()
	itemValues := make([]Resource_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
...
func (b *filterCndBuilderVersionedInfos) compare(op gotenfilter.CompareOperator, value []*Resource_VersionedInfo) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                op,
		Resource_FieldPathValue: NewResourceFieldPathBuilder().VersionedInfos().WithValue(value),
	})
}

func (b *filterCndBuilderVersionedInfos) Version() *filterCndBuilderVersionedInfosVersion {
	return &filterCndBuilderVersionedInfosVersion{builder: b.builder}
}

func (b *filterCndBuilderVersionedInfos) IsRegional() *filterCndBuilderVersionedInfosIsRegional {
	return &filterCndBuilderVersionedInfosIsRegional{builder: b.builder}
}

type filterCndBuilderVersionedInfosVersion struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderVersionedInfosVersion) Eq(value string) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderVersionedInfosVersion) Neq(value string) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderVersionedInfosVersion) Gt(value string) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderVersionedInfosVersion) Gte(value string) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderVersionedInfosVersion) Lt(value string) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderVersionedInfosVersion) Lte(value string) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderVersionedInfosVersion) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Resource_FieldPathArrayOfValues: NewResourceFieldPathBuilder().VersionedInfos().Version().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderVersionedInfosVersion) NotIn(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Resource_FieldPathArrayOfValues: NewResourceFieldPathBuilder().VersionedInfos().Version().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderVersionedInfosVersion) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewResourceFieldPathBuilder().VersionedInfos().Version().FieldPath(),
	})
}

func (b *filterCndBuilderVersionedInfosVersion) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewResourceFieldPathBuilder().VersionedInfos().Version().FieldPath(),
	})
}

func (b *filterCndBuilderVersionedInfosVersion) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                op,
		Resource_FieldPathValue: NewResourceFieldPathBuilder().VersionedInfos().Version().WithValue(value),
	})
}

type filterCndBuilderVersionedInfosIsRegional struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderVersionedInfosIsRegional) Eq(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderVersionedInfosIsRegional) Neq(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderVersionedInfosIsRegional) Gt(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderVersionedInfosIsRegional) Gte(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderVersionedInfosIsRegional) Lt(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderVersionedInfosIsRegional) Lte(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderVersionedInfosIsRegional) In(values []bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Resource_FieldPathArrayOfValues: NewResourceFieldPathBuilder().VersionedInfos().IsRegional().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderVersionedInfosIsRegional) NotIn(values []bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Resource_FieldPathArrayOfValues: NewResourceFieldPathBuilder().VersionedInfos().IsRegional().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderVersionedInfosIsRegional) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewResourceFieldPathBuilder().VersionedInfos().IsRegional().FieldPath(),
	})
}

func (b *filterCndBuilderVersionedInfosIsRegional) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewResourceFieldPathBuilder().VersionedInfos().IsRegional().FieldPath(),
	})
}

func (b *filterCndBuilderVersionedInfosIsRegional) compare(op gotenfilter.CompareOperator, value bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                op,
